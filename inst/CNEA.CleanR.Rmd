...
for(i in 1:length(input$N.define)) {
  ...
  dataTemp <- resultMatrix()[which(resultMatrix()$Identifier.1 == input$N.define[i]),]
...
for(i in 1:length(input$C.define)) {
  ...
  dataTemp <- resultMatrix()[which(resultMatrix()$Identifier.1 == input$C.define[i]),]
...
return(table1)
  ...
  write.csv(table1(), file = paste0("table1_",toAdd, ".csv" ))
...
output$dataSampleKarina <- renderDT({
  ...
  write.csv(table2.sample.Karina(), file = paste0("table2.sample.Karina_",toAdd, ".csv" ))
...
output$FinalTable <- renderDT({
  ...
  write.csv(table2.sample.Peter(), file = paste0("table2.sample.Peter_",toAdd, ".csv" ))
  table2.sample.Peter()
})
```
