...
```{r echo = FALSE}
#  radioButtons("essaiTry", label = "",
#     choices = c("Yes", "No"), 
#     selected = "No")
# 
# essai <- reactive({
#   if(!is.null(input$essaiTry)){
#     if(input$essaiTry == "Yes"){
#       TRUE
#     } else {
#       FALSE
#     }
...
### 4. Split the TCD into two table TCD.standards (containing all the standard and blank values) and TCD.sample (containing only the sample)
